...
- [x] One executable name constant used by `timetracker.spec`, `build.bat`, `update_checker.ASSET_NAME`, and `self_installer` (install target and `_kill_running_instances`)
